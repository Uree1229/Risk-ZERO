...
| Camera control | Voltly `VLT-CAM003` OV7670 실물 식별. parameterized 25 MHz XCLK, SCCB read/write, PID/VER probe, YUV422 Y 추출, async FIFO RTL·Vivado XSIM 통과 | 모듈 I/O 전압·level shifting·핀, init table·PWDN/RESET·top 연결 미확정 |
...
- FPGA Python protocol/reference/asset 테스트 17개 통과
